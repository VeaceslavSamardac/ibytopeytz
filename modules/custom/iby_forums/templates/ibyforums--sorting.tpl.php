...
echo '<li style="float:left;margin:0;padding:0;margin-left:15px;"><a href="'.$base_link.'#tags" '.((!isset($_GET['o'])) ? 'class="current_filter_option"' : "").'>Latest</a></li>'."\n";
echo '<li style="float:left;margin:0;padding:0;margin-left:15px;"><a href="'.$base_link.'?o=comment#tags" '.((isset($_GET['o']) && ($_GET['o'] == 'comment')) ? 'class="current_filter_option"' : "").'>Most commented</a></li>'."\n";
