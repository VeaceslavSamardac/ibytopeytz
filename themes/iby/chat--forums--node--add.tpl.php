...
<div id="node-add-content" style="width:490px; height:795px;background-color:#f9f7f1;overflow-x:hidden; overflow-y:auto;padding: 0 20px;" class="chat-forums-add-topic node-add-content box-shadow">
