...
<div id="node-add-content" class="challenges-add-topic node-add-content" style="width:710px;background-color:#f9f7f1;overflow-x:hidden; overflow-y:auto;padding: 0 20px;">
	...
	<div class="tips_trics_ajax_popup_right popout-right">
		<h2>Join the innovation in 4 easy steps</h2>		
		<img src="/<?php echo sqtools_default_theme_path(); ?>/images/ajax_comment_popup_image.png" width="185px"/>
	</div>
</div>
